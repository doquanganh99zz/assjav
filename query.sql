...
VALUES
('B82380BF-1F62-4C5B-877E-23FA18DB47C8','SV1',N'Hoàng Thùy Linh','thuylinhhoang@gmail.com','096996761',1,N'Hà Nội',(SELECT * FROM OPENROWSET(BULK 'D:\img\1.jpg', SINGLE_BLOB) AS IMG)),
('0837AB06-73C9-4E31-996F-398246553207','SV2',N'Thái Linh Hương','huongak47@gmail.com','091235461',0,N'Hà Nam',(SELECT * FROM OPENROWSET(BULK 'D:\img\2.jpg', SINGLE_BLOB) AS IMG)),
('1B119DC5-9F9E-4436-8F99-89EEBD66F659','SV3',N'Mộc Quế Anh','mocqueanh69@gmail.com','0123449641',1,N'Thái Bình',(SELECT * FROM OPENROWSET(BULK 'D:\img\3.jpg', SINGLE_BLOB) AS IMG)),
('EB46A354-A6F7-4A05-8C02-8B2E2FA14BE8','SV4',N'Địch Lệ','chingchongchingchong@gmail.com','0112455761',0,N'Ching Chong',(SELECT * FROM OPENROWSET(BULK 'D:\img\4.jpg', SINGLE_BLOB) AS IMG))
------------------------
