...
VALUES
('B82380BF-1F62-4C5B-877E-23FA18DB47C8','SV1',N'Hoàng Thùy Linh','thuylinhhoang@gmail.com.vn','09699676111',1,N'Hà Nội',(SELECT * FROM OPENROWSET(BULK 'D:\img\1.jpg', SINGLE_BLOB) AS img)),
('0837AB06-73C9-4E31-996F-398246553207','SV2',N'Thái Linh Hương','huongak47@gmail.com.vn','09123546111',0,N'Hà Nam',(SELECT * FROM OPENROWSET(BULK 'D:\img\2.jpg', SINGLE_BLOB) AS img)),
('1B119DC5-9F9E-4436-8F99-89EEBD66F659','SV3',N'Mộc Quế Anh','mocqueanh69@gmail.com.vn','012344964221',1,N'Thái Bình',(SELECT * FROM OPENROWSET(BULK 'D:\img\3.jpg', SINGLE_BLOB) AS img)),
('EB46A354-A6F7-4A05-8C02-8B2E2FA14BE8','SV4',N'Địch Lệ','chingchongchingchong@gmail.com.vn','01124557361',0,N'Ching Chong',(SELECT * FROM OPENROWSET(BULK 'D:\img\4.jpg', SINGLE_BLOB) AS img)),
('DF5B3A5B-566E-4B65-AEB2-9212073488A5','SV5',N'Phạm Băng Băng','banban99@gmail.com.vn','0546645761',0,N'Malibu',(SELECT * FROM OPENROWSET(BULK 'D:\img\4.jpg', SINGLE_BLOB) AS img))
------------------------
...
--------------------------
GO
ALTER PROC GETDATASTUDENT
AS
BEGIN
SELECT DBO.STUDENTS.MASV,DBO.STUDENTS.HOTEN,DBO.STUDENTS.EMAIL,DBO.STUDENTS.SODT,DBO.STUDENTS.GIOITINH,DBO.STUDENTS.DIACHI,dbo.STUDENTS.AVATAR FROM DBO.STUDENTS ORDER BY COUNTLIST ASC
END
----------------------------
GO
ALTER PROC ADDNEWSTUDENT(@MASV VARCHAR(50),@HOTEN NVARCHAR(50),@EMAIL VARCHAR(50),@SODT VARCHAR(50),@GIOITINH VARCHAR(2),@DIACHI NVARCHAR(50),@AVATAR NVARCHAR(MAX))
AS
BEGIN
INSERT INTO DBO.STUDENTS
VALUES
