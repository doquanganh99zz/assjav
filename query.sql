...
VALUES
('B82380BF-1F62-4C5B-877E-23FA18DB47C8','SV1',N'Hoàng Thùy Linh','thuylinhhoang@gmail.com.vn','09699467623',1,N'Hà Nội',(SELECT * FROM OPENROWSET(BULK 'D:\img\1.jpg', SINGLE_BLOB) AS IMG)),
('0837AB06-73C9-4E31-996F-398246553207','SV2',N'Thái Linh Hương','huongak47@gmail.com.vn','09123432246',0,N'Hà Nam',(SELECT * FROM OPENROWSET(BULK 'D:\img\2.jpg', SINGLE_BLOB) AS IMG)),
('1B119DC5-9F9E-4436-8F99-89EEBD66F659','SV3',N'Tiểu Thủy Ngư','thuyngu69@gmail.com.vn','02344934643',1,N'Thái Bình',(SELECT * FROM OPENROWSET(BULK 'D:\img\3.jpg', SINGLE_BLOB) AS IMG)),
('EB46A354-A6F7-4A05-8C02-8B2E2FA14BE8','SV4',N'Địch Lệ Nhiệt Ba','chingchong123@gmail.com.vn','01242557436',0,N'Ching Chong',(SELECT * FROM OPENROWSET(BULK 'D:\img\4.jpg', SINGLE_BLOB) AS IMG))
------------------------
...
--------------------------------
GO
alter PROC REMAKESTUDENT(@MASV VARCHAR(50),@HOTEN NVARCHAR(50),@EMAIL VARCHAR(50),@SODT VARCHAR(50),@GIOITINH VARCHAR(2),@DIACHI NVARCHAR(50),@AVATAR NVARCHAR(MAX))
AS
BEGIN
UPDATE DBO.STUDENTS
SET HOTEN = @HOTEN,
